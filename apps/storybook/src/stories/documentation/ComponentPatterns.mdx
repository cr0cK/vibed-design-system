...
<Meta title="Documentation/3. Patterns" parameters={{ options: { showPanel: false } }} />
...
- Reuse existing tokens and variants before introducing new ones.
- Favor `controlSize` and semantic tone variants over inline one-off styling.
- Keep naming uniform across families (`open`, `onClose`, `tone`, `controlSize`).
...
- `Documentation/3. Patterns/Styling`
- `Documentation/3. Patterns/State`
- `Documentation/3. Patterns/Control Size`
